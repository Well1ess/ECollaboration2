 ...
 * Description: 获取我项目下的执行团队
 */

public class TransForGetMyJoinTeamInfo extends AsyncTask<String, Integer, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            java.net.URL url = new java.net.URL(URL.getGetMyJoinTeamsInfoAction(params[0]));
            con = (HttpURLConnection) url.openConnection();

            log.d(this, URL.getGetMyJoinTeamsInfoAction(params[0]));
        ...
        if (result != null) {
            try {
                ...
                if (resultFlag.equals("success")) {
                    ...
                    List<ProjectDTO> projectDTOs = new Gson().fromJson(jsonObject.getString("projectBean"), type);

                    GlobalUtil.getInstance().setMyExeProjectDTOs(projectDTOs);
                    //TO:TeamMainFragment
