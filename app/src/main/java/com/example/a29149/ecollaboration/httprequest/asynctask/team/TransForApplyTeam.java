...
public class TransForApplyTeam extends AsyncTask<String, Integer, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            java.net.URL url = new java.net.URL(URL.getApplyTeam(params[0]));
            log.d(this, URL.getApplyTeam(params[0]));
