...
public class TransForGetTeamByProject extends AsyncTask<String, Integer, String>{

    public TransForGetTeamByProject( ) {
    }
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            java.net.URL url = new java.net.URL(URL.getTeamsBySchool(params[0]));
            log.d(this, URL.getTeamsBySchool(params[0]));
