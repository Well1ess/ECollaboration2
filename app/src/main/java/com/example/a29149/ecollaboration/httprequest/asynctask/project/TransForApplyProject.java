 ...
 * Description: apply project
 */

public class TransForApplyProject extends AsyncTask<String, Integer, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            java.net.URL url = new java.net.URL(URL.getApplyProjectURL(params[0], params[1]));
            log.d(this, URL.getApplyProjectURL(params[0], params[1]));
        ...
        if(result!=null)
        {
            try
            {
                ...
                if (resultFlag.equals("success")) {
                    ...
                    EventBus.getDefault().post(new HttpResponseEvent(true, "申请已发送"));

                } else {
                    EventBus.getDefault().post(new HttpResponseEvent(false, "申请失败！"));
                }
