 ...
 * Description: 获取所有特定团队的特定项目的特定任务
 */

public class TransForTargetTeamsTask extends AsyncTask<String, Integer, String> {

    public TransForTargetTeamsTask() {
    }
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            java.net.URL url = new java.net.URL(URL.getMyTeamsProjectsTask(params[0]));
            log.d(this, URL.getMyTeamsProjectsTask(params[0]));
        ...
        if (result != null) {
            try {
                ...
                if (resultFlag.equals("success")) {
                    ...
                    java.lang.reflect.Type type = new com.google.gson.reflect.TypeToken<List<TaskDTO>>() {
                    }.getType();

                    List<TaskDTO> taskDTOList = new Gson()
                            .fromJson(jsonObject.getString("TaskBeans"), type);

                    GlobalUtil.getInstance().setMyExeTask(taskDTOList);
                } else {
