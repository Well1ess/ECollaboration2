...
public class TransForGetRefuseApplyProject extends AsyncTask<String, Integer, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            java.net.URL url = new java.net.URL(URL.getAppRefuseJoinProjectApply(params[0]));
            log.d(this, URL.getAppRefuseJoinProjectApply(params[0]));
        ...
        if(result!=null)
        {
            try
            {
                ...
                if (resultFlag.equals("success")) {
                    ...
                    EventBus.getDefault().post(new HttpResponseEvent(true, "已回绝该项目申请"));
