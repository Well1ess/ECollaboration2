...
public class TransForGetAcceptApplyTeam extends AsyncTask<String, Integer, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            java.net.URL url = new java.net.URL(URL.getAppAcceptJoinTeamApplyURL(params[0]));
            log.d(this, URL.getAppAcceptJoinTeamApplyURL(params[0]));
        ...
        if(result!=null)
        {
            try
            {
                ...
                if (resultFlag.equals("success")) {
                    ...
                    EventBus.getDefault().post(new HttpResponseEvent(true, "已接受该团队申请"));
